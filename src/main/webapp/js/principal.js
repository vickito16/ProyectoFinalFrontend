...
// --- CRIPTOGRAFÍA MANUAL (CLIENTE) ---
const ManualCrypto = {
    // Mismo Primo gigante que en el servidor
    ...
    finalizeHandshake(serverPublicKeyHex) {
        try {
            ...
            console.log("🔒 [ManualCrypto] Handshake completado.");
            return true;
        } catch(e) {
            console.error(e);
            return false;
...
// --- RESTO DEL CÓDIGO (Variables y WS) ---
...
function conectarChat() {
    // CAMBIA LA IP AQUI POR LA DE TU MAQUINA (BACKEND)
...
function iniciarBucleHandshake() {
    ...
    mostrarMensajeSistema("⏳ Conectando seguro (Modo IP)...");
...
function sendMessage(e) {
    ...
    if (!ManualCrypto.isHandshakeComplete) {
        alert("Espere a la conexión segura...");
        return;
    }
